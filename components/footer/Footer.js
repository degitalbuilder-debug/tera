      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-xl font-semibold text-pink-600">TeraLinkPlayer</h2>
        ...
        <div className="border-t border-gray-300 mt-8 pt-6 text-center text-sm">
          <p>
            © {year} <span className="font-medium text-pink-600">TeraLinkPlayer</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
